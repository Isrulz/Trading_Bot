...
- **Report Generated**: 2026-07-06 18:03:58 AEST
...
- **95th Percentile Max Drawdown (Sequence Risk)**: 11.58%

## Conclusion
The Monte Carlo simulation confirms the strategy's resilience against sequence of return risks. The 95th percentile Maximum Drawdown remains at **11.58%**, which is well within the **15%** absolute maximum risk limit constraint.
